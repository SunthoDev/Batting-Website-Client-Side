...
const SearchReport = () => {
    ...
    let { Date } = useContext(AuthContext)
    ...
    // (TODAY) All Data Find
    // =================================================
    const todayAllUserData = adminAllUsers?.filter(user => user.date === Date);
    ...
    // (TODAY) All Data Find
    // =================================================
    const todayAllRecharge = AllRecharge?.filter(Recharge => Recharge.date === Date);
    // console.log(todayParcelData)
    ...
    // (TODAY) All Data Find
    // =================================================
    const todayAllSubscription = AllSubscription?.filter(Sub => Sub.date === Date);
    // console.log(todayParcelData)
    ...
    // (TODAY) All Data Find
    // =================================================
    const todayAllWithdraw = AllWithdraw?.filter(Withdraw => Withdraw.date === Date);
    // console.log(todayParcelData)
    ...
    // (TODAY) All Data Find
    // =================================================
    const todayAllCouponBonus = AllCouponBonus?.filter(Coupon => Coupon.date === Date);
    // console.log(todayParcelData)
        ...
        <div className="min-h-screen bg-gray-100 py-10 px-4 md:px-16">
            <div className="bg-white shadow-xl rounded-2xl p-8">
                ...
                <h1 className="text-3xl font-bold text-gray-800 text-center md:text-left">
                    📊 Search All Report Of This Website
                </h1>
