...
const SingUp = () => {
    ...
    return (
        <div className='SingUpParent bg-white pt-[100px] pb-[100px] px-4'>
            <ToastContainer />

            <div className='SingUp w-[100%] lg:w-[440px] md:mx-auto rounded-[4px]'>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className='FromData px-3 md:px-[20px]' >
                            ...
                            <div className="">
                                <div className='relative'>
                                    <input className='bg-white mt-[23px] text-black text-[14px] font-[600] rounded-[6px] py-[14px] px-[24px] w-[100%]' placeholder='First Name' type="text" {...register("FirstName", { required: true })} name='FirstName' />
                                ...
                                <div className='relative'>
                                    <input className='bg-white mt-[23px] text-black text-[14px] font-[600] rounded-[6px] py-[14px] px-[24px] w-[100%]' placeholder='Last Name' type="text" {...register("LastName", { required: true })} name='LastName' />
                                    <h4 className='absolute font-[600] top-[34px] right-[22px] text-[18px]'><i class="fa fa-user" aria-hidden="true"></i></h4>
                                    {errors.LastName && <span className='text-red-600 font-semibold'>Your Last Name is required</span>}
                                </div>
                            </div>
                            <div className='relative'>
                                <input className='bg-white mt-[23px] text-black text-[14px] font-[600] rounded-[6px] py-[14px] px-[24px] w-[100%]'
                            ...
                            <div className="">
                                <div className='relative'>
                                    <input className='bg-white mt-[23px] text-black text-[14px] font-[600] rounded-[6px] py-[14px] px-[24px] w-[100%]' placeholder='Password' type={xx == true ? "password" : "text"} name='password'
                                        {...register("password",
                                            {
                                                required: true,
                                            })}
                                ...
                                <div className='relative'>
                                    <input className='bg-white mt-[23px] text-black text-[14px] font-[600] rounded-[6px] py-[14px] px-[24px] w-[100%]' placeholder='Confirm Password' type={xx == true ? "password" : "text"}    {...register("confirmPassword", { required: true })} name='confirmPassword' />
                                    <button onClick={() => setXx(!xx)} className='absolute top-[34px] right-[22px] text-[18px]'>
                                        <i className={xx === true ? "fa fa-lock" : "fa fa-unlock"} aria-hidden="true"></i>
                                    </button>
                            ...
                            <div className='relative'>
                                <input className='mt-[23px] bg-white text-black text-[14px] font-[600] rounded-[6px] py-[14px] px-[24px] w-[100%]' placeholder='Refer Code Please' type="number" {...register("ReferCode", { required: true })} name='ReferCode' defaultValue={UserReferUseAccount} />
                                <h4 className='absolute font-[600] top-[34px] right-[22px] text-[18px]'><i class="fa fa-user" aria-hidden="true"></i></h4>
                            ...
                            {/* ========================= */}
                            <h3 className="mt-[23px] mb-[18px] text-[14px] font-[400] text-black ">Already have an account? <Link className='text-[#f93333] text-[15px] font-[500] ' to="/login">Login</Link></h3>
